...
class ri_ccap_eligible(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        # RI Works (TANF) recipients are categorically eligible.
        ri_works_categorical = spm_unit("is_tanf_enrolled", period)
        return has_eligible_child & (
            (income_eligible & asset_eligible) | ri_works_categorical
        )

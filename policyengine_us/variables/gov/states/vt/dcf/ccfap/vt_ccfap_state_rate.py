...
class vt_ccfap_state_rate(Variable):
    ...
    label = "Vermont CCFAP weekly state rate per child"
    reference = (
        "https://outside.vermont.gov/dept/DCF/Shared%20Documents/CDD/CCFAP/State-Rates.pdf",
        "https://outside.vermont.gov/dept/DCF/Shared%20Documents/CDD/CCFAP/Capped-State-Rates.pdf",
    )

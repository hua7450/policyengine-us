...
class wa_ssp_payment_category(Variable):
    ...
    def formula(person, period, parameters):
        ...
        # WAC 388-474-0012(5) added a standalone disabled category effective
        # 2023-12-28 (WSR 23-24-009). Before that date, disabled-only people
        # who weren't also aged/blind/with-ineligible-spouse did not qualify.

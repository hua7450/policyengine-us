...
class wy_ccap_eligible_child(Variable):
    ...
    reference = (
        "https://drive.google.com/file/d/1yatL28Yylj62R2cTipV2sGa10TxZplxr/view",  # Wyo. Admin. Rules, DFS, Child Care - Purchase of Service, Ch. 1 §8(e)(i)(A), (e)(ii), eff. 05/07/2025 (PDF pp. 16, 18)
        "https://drive.google.com/file/d/1fQaSE7s66OY0c3M8-gMeB9WWm_CFpCQ5/view",  # Wyoming DFS Child Care Subsidy Policy Manual §601 (PDF p. 1)
    )
